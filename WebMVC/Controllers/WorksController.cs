...
public class WorksController : Controller
{
    ...
    public async Task<IActionResult> Create(Work work)
    {
        ...
        {
            ModelState.AddModelError(string.Empty, "Помилка: не вдалося визначити ваш ID користувача. Спробуйте вийти з акаунта і зайти знову.");
    ...
    public async Task<IActionResult> Edit(int id, Work work)
    {
        ...
        if (ModelState.IsValid)
        {
            try
            {
                ...
                workInDb.StudentId = work.StudentId;
